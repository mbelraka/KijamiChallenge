            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        {{Form::model($client, array('route' => array('users.update', $client), 'method' => 'PUT', 'class' => 'form-horizontal'))}}
                        <div class="form-group {{($errors->has('name'))? 'has-error':''}}">
                            {{Form::label('name', $value = 'Client name', $attributes=['class' => 'col-md-4 control-label'])}}
                            <div class="col-md-6 {{($errors->has('name'))? 'has-error':''}}">
                                {{Form::text('name', $value = $client->name,  $attributes=['class' => 'form-control', 'placeholder'=> 'Client name'])}}
                                @if($errors->has('name'))
                                    <div class="has-error">
                        ...
                        <div class="form-group {{($errors->has('email'))? 'has-error':''}}">
                            ...
                            <div class="col-md-6 {{($errors->has('email'))? 'has-error':''}}">
                                {{Form::email('email', $value = $client->email,  $attributes=['class' => 'form-control', 'placeholder'=> 'Client email'])}}
                                @if($errors->has('email'))
                                    <div class="has-error">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                ...
                                <a class="btn btn-danger" href="{{URL::to('users', array($client, 'delete'))}}">Delete</a>
